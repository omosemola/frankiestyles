    ...
    content: (
      <div className="space-y-6">
        ...
        <div className="space-y-4 text-sm text-gray-600 leading-relaxed font-light">
          ...
          <p>
            We offer <strong>complimentary fitting adjustments</strong> within <strong>14 days</strong> of receiving your garment. If your kaftan, senator, or agbada requires micro-alterations (sleeve length, chest adjustments, or pant cuffing), please contact us at <a href="mailto:tailoring@frankiestyles.com" className="font-bold text-black underline">tailoring@frankiestyles.com</a> to arrange a fitting session in our Lekki studio or to ship the item back.
          </p>
