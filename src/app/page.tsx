      ...
      <section className="py-24 bg-white">
        <div className="container mx-auto px-6 text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
             <Link href="/shop?category=Kaftans" className="relative aspect-[16/9] overflow-hidden group rounded-lg cursor-pointer block">
             ...
             <Link href="/shop?category=Senator+Wears" className="relative aspect-[16/9] overflow-hidden group rounded-lg cursor-pointer block">
