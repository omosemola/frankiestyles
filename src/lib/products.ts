...
export const DUMMY_PRODUCTS: Product[] = [
  ...
  {
    id: "14",
    name: "Royal Blue Textured Kaftan Set",
    price: 220000,
    category: "Kaftans",
    image: "/images/product-14-front.png",
    isNew: true,
    description: "Exude confidence in this royal blue textured Kaftan. Masterfully tailored from premium waffle-textured fabric, it features a clean round neck, short-placket front closure, a single chest pocket with a gold brand plate, and matching trousers.",
    details: [
    ...
    images: [
      "/images/product-14-front.png",
      "/images/product-14-back.png"
    ],
    sizes: [
      "M (Chest 38-40\")",
      "L (Chest 41-43\")",
  ...
  {
    id: "16",
    name: "Navy Blue Textured Kaftan Set",
    price: 220000,
    category: "Kaftans",
    image: "/images/product-16-front.png",
    isNew: true,
    description: "Exude luxury in this navy blue textured Kaftan. Masterfully tailored from premium waffle-textured fabric, it features a clean round neck, short-placket front closure, a single chest pocket with a gold brand plate, and matching trousers.",
    details: [
      "Two-piece premium Kaftan set",
      "Premium waffle-textured cotton-crepe blend fabric",
      "Round neckline with clean buttonless placket design",
    ...
    images: [
      "/images/product-16-front.png",
      "/images/product-16-back.png"
    ],
    sizes: [
      "M (Chest 38-40\")",
      "L (Chest 41-43\")",
  ...
  {
    id: "21",
    name: "Mint Green Luxury Kaftan Set",
    price: 220000,
    category: "Kaftans",
    image: "/images/product-21-front.png",
    isNew: true,
    description: "Elevate your look in this mint green luxury Kaftan. Tailored with care from premium waffle-textured fabric, it offers a clean round neck, short-placket front closure, a single chest pocket with a gold brand plate, and matching trousers.",
    details: [
      "Two-piece premium Kaftan set",
      "Premium waffle-textured cotton-crepe blend fabric",
      "Round neckline with clean buttonless placket design",
