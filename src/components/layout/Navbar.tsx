...
export function Navbar() {
  ...
  // Home and About pages have dark hero sections at the top
    ...
    <>
      ...
      >
        <div className="w-full relative pointer-events-auto">
          ...
          <div className="container mx-auto px-6 md:px-10 lg:px-16 py-0 md:py-6 lg:py-6 flex items-center justify-between relative mt-3 mb-2 md:mt-3 md:mb-8 lg:mt-3 lg:mb-10">
            ...
            <div className="md:absolute md:left-10 lg:left-16 top-1/2 md:-translate-y-1/2 flex items-center z-10">
              <Link href="/" className="flex items-center">
                ...
                <img
                  ...
                  className={cn(
                    "h-24 md:h-20 lg:h-24 w-auto object-contain transition-all duration-[1000ms]",
